    ...
    <div class="max-w-lg mx-auto bg-white p-6 rounded-lg shadow-lg">
        ...
        <form action="{{ route('offday.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="space-y-1">
                ...
                <input type="date" id="offday_date" name="offday_date" required
                    class="block w-full border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500 p-2">
            </div>
            ...
            <button type="submit"
                class="w-full py-3 px-4 bg-indigo-600 hover:bg-indigo-700 text-white font-medium rounded-lg shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition duration-200">
                İzin Talebi Oluştur
            </button>
        </form>
    </div>
