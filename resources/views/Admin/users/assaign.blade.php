...
<div class="flex-1 p-8 mt-8">
    ...
    <form class="max-w-lg mx-auto bg-white p-8 rounded-lg shadow-lg space-y-6" action="{{ route('admin.tasks.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-4">
            ...
            <input type="file" id="attachments" name="attachments" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" accept=".zip">
        </div>
