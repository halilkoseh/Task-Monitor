...
@section('content')
    ...
    <div id="contact"
        class="w-screen max-w-4xl mx-auto px-6 py-12 md:px-16 border-2 border-white bg-white rounded-lg shadow-lg mt-32 mr-64 mb-32">
        ...
        <div class="bg-white p-8 rounded-lg shadow-lg mb-8 max-w-lg mx-auto border border-gray-200 text-center">
            <h1 class="text-4xl font-extrabold mb-6 text-gray-800 flex justify-center items-center">
                <i class="fa-solid fa-headset mr-4 text-blue-600"></i> Destek
            </h1>
            <p class="text-gray-700 text-lg leading-relaxed mb-6">
                Yöneticinizle iletişime geçmek için<br> lütfen aşağıdaki iletişim formunu kullanın.
            </p>
        ...
        <div class="flex flex-col md:flex-row justify-center items-center">
            ...
            <!-- Left contact page -->
            <form id="contact-form" class="w-full md:w-1/2 space-y-6 mt-8" role="form"
            ...
            <div class="w-full md:w-1/2 mt-10 md:mt-0 space-y-8 md:ml-16 ">
                ...
                <ul class="flex justify-center space-x-6 text-3xl">
                    <li><a href="#" target="_blank" class="hover:text-[#7F7F7F]"><i class="fab fa-github"></i></a>
                    </li>
                    <li><a href="#" target="_blank" class="hover:text-[#7F7F7F]"><i class="fab fa-codepen"></i></a>
                    </li>
                    <li><a href="#" target="_blank" class="hover:text-[#7F7F7F]"><i class="fab fa-twitter"></i></a>
                    </li>
                    <li><a href="#" target="_blank" class="hover:text-[#7F7F7F]"><i class="fab fa-instagram"></i></a>
                    </li>
                </ul>
                ...
                <div class="text-center text-gray-500 text-sm">
                    &copy; Tüm Hakları Saklıdır. <br>Task Monitor 2024
                </div>
            </div>
    ...
    <div id="popup-message" class="fixed inset-0 flex items-center justify-end bg-gray-900 bg-opacity-70 hidden">
        <div class="bg-white p-8 rounded-lg shadow-2xl max-w-sm w-full">
            ...
            <p class="text-lg font-semibold text-gray-800">Mesajınız yöneticiye iletilmiştir. <br> Mail gelen kutusunu takip
                ediniz.
            ...
            <div class="mt-6 flex justify-center">
                <button onclick="closePopup()"
                    class="bg-green-500 hover:bg-green-600 text-white font-semibold py-2 px-4 rounded focus:outline-none focus:ring-2 focus:ring-green-300 transition duration-300">Tamam</button>
            </div>
        </div>
    </div>
