        ...
        <div class="bg-blue-50 mt-8">
            <div class="max-w-4xl mt-8 mx-auto p-6">
                <div class="bg-white p-6 rounded-lg shadow-lg mb-6">
                    <h1 class="text-3xl font-bold mb-4 text-gray-700"><i class="fa-solid fa-id-card mr-2"></i> Ayarlar</h1>
                    <p>Profil bilgilerinizi görüntüleyebilir, değişiklik yapabilir veya olası hataları bildirebilirsiniz.</p>
                </div>

                <div class="bg-white p-8 rounded-lg shadow-lg">
                    <div class="flex items-center space-x-4 mb-6">
                        <img class="w-20 h-20 rounded-full object-cover" src="{{ asset('images/' . $user->profilePic) }}"
                            alt="Profil Resmi">
                        <div>
                    ...
                    <h3 class="text-lg font-semibold mb-4 text-gray-800">Kullanıcı Bilgileri</h3>
                    ...
                    <form class="bg-[#fff] items-center flex justify-center">
                      

                        @if ($user->id == 1)
                            <div class="bg-[#EEF6FF] p-4 rounded border border-gray-300 ">
                                <p class="text-gray-700 text-lg mb-4 flex justify-center">
                                    Bilgilerde herhangi bir yanlışlık olduğunu düşünüyorsanız lütfen bize bildirin.
                                </p>
                                <a href="mailto:{{ $user->email }}"
                                    class="text-blue-500 hover:text-blue-700 flex justify-center">{{ $user->email }}</a>
                            </div>
                        @endif

                        <!-- Optionally, you can include a submit button or other form elements here -->
                    </form>
