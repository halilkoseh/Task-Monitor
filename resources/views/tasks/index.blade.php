            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-2">
                <div class="bg-white p-6 md:p-10 rounded-lg shadow-lg relative">
                    <a href="{{ route('admin.users.show') }}"
                        class="see-all-link absolute top-3 right-3 text-sky-500 hover:text-blue-600">
                        Tümünü Gör
                    ...
                    <div class="relative">
                        <div class="project-box bg-white rounded-md shadow-md p-4">
                            ...
                            @foreach ($projects->take(2) as $index => $project)
                                @php$iconBackgroundColors = ['bg-sky-100', 'bg-green-100', 'bg-orange-100'];
                                ...
                                $icon = $iconData[$index % count($iconData)]; @endphp
                    ...
                    @foreach (['Atandı', 'basladi', 'Devam Ediyor', 'Test Ediliyor', 'Tamamlandı'] as $index => $status)
                        ...
                        <div class="p-4 rounded-lg shadow-lg min-h-[200px] md:min-h-[250px] lg:min-h-[300px] bg-white"
                            ...
                            <div class="flex justify-between items-center mb-4">
                                ...
                                <span
                                    class="bg-white text-gray-800 px-2 py-1 rounded-full shadow">{{ $statusCount }}</span>
                            </div>
                            @foreach ($userTasks as $user)
                                @foreach ($user->tasks as $task)
                                    @if ($task->status == $status)
                                        <div class="task-card p-4 mb-4 rounded-lg shadow-md relative bg-white"
                                            ...
                                            <div class="flex justify-between items-center mb-2">
                                                <h3 class="font-semibold text-md sm:text-lg truncate max-w-xs">
                                                    {{ $task->title }}</h3>
                                            ...
                                            <div class="flex justify-between items-center">
                                                <div class="flex items-start">
                                                    <span
                                                        class="italic font-light text-gray-400">{{ $user->name }}</span>
                                                    <img class="h-6 w-6 rounded-full ml-3"
                                                        src="{{ asset('images/' . $user->profilePic) }}"
                                                        alt="{{ $user->name }}" />
                                                </div>
