    ...
    <div class="container mx-auto p-4">
            ...
            <div class="bg-white p-10 rounded-lg shadow-lg relative">
                ...
                <div class="relative">
                    <div class="project-box">
                        ...
                        @foreach($projects->take(3) as $index => $project) @php $iconBackgroundColors = ['bg-orange-100', 'bg-purple-100', 'bg-sky-100']; $iconColors = ['text-orange-600', 'text-purple-500', 'text-sky-500']; $iconData = [
                        ['icon' => 'fa-code'], ['icon' => 'fa-project-diagram'], ['icon' => 'fa-tasks'], ]; $bgColor = $iconBackgroundColors[$index % count($iconBackgroundColors)]; $iconColor = $iconColors[$index % count($iconColors)];
        ...
        <div class="bg-transparent py-3 px-3">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-5 gap-4 task-board text-gray-600">
                ...
                <div
                    class="p-4 rounded-lg shadow-lg min-h-[300px]"
