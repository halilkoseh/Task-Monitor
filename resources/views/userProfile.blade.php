...
@section('content')
    ...
    <div class="content-container mx-auto w-screen bg-[#EEF6FF]">
                ...
                <div class="bg-white p-8 rounded-lg shadow-md">
                    ...
                    @if ($user->id != 1)
                        <div class="bg-blue-50 p-6 mt-8 rounded-lg border border-blue-200 text-center">
                            ...
                            <a href="mailfrom:{{ $user->email }}" class="text-blue-500 hover:text-blue-700 transition duration-200">admin@admin.com</a>
                        </div>
                    @endif
